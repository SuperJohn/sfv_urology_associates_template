(function($) {
    ...
    if ($('#map-location').length) {
        ...
        map.addMarker({
            ...
            lng: -118.535153,
            infoWindow: {
                content: '<p style="text-align:center;"><strong>West Hills Office</strong><br>18370 Burbank Blvd. Tarzana, CA 91356</p>'
            }
        ...
        map.addMarker({
            ...
            lng: -118.535153,
            infoWindow: {
                content: '<p style="text-align:center;"><strong>Tarzana Office</strong><br>7345 Medical Center Drive, Suite 300 West Hills, CA 91307</p>'
            }
