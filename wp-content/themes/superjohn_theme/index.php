	...
	<body>
		<div class="page-wrapper">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
							<article class="inner-box">
								...
								<div class="content">
									...
									<div class="link"><a href="#" class="read-more normal-btn theme-btn" style="background:#770a12;"><span class="fa fa-caret-right"></span> MORE INFO</a></div>
								</div>
							</article>
						</div>
						...
						<div class="col-md-4 col-sm-6 col-xs-12 column wow fadeInUp" data-wow-delay="700ms" data-wow-duration="1500ms">
							<article class="inner-box">
								...
								<div class="content">
									...
									<div class="link"><a href="#" class="read-more normal-btn theme-btn" style="background:#111f44;"><span class="fa fa-caret-right"></span> MORE INFO</a></div>
								</div>
							</article>
						</div>
			...
			<section class="why-us-section">
				...
				<div class="bg-image" style="background-image:url(images/why.jpg);"></div>
					...
					<div class="row clearfix">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 column">
							<article class="row clearfix">
								<figure class="col-md-6 col-sm-6 col-xs-12 image"><a href="#"><img src="http://www.sfvua.com/images/p-drDula2.jpg" alt=""></a></figure>
								<div class="col-md-6 col-sm-6 col-xs-12 content">
									...
									<div class="text">
										<p>Etiam dignissim sit amet felis ac sagittis. Sed libero arcu, pharetra et ante in, elementum scelerisque arcu. Curabitur sagittis non justo at ultricies odio ac diam finibus. Etiam dignissim sit amet felis ac sagittis. Sed libero arcu, pharetra et ante in, elementum scelerisque arcu. Curabitur sagittis non justo at ultricies odio ac diam finibus.</p>
									</div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12 column">
							<article class="row clearfix">
								<figure class="col-md-6 col-sm-6 col-xs-12 image"><a href="#"><img src="http://www.sfvua.com/images/p-drleff.jpg" alt=""></a></figure>
								<div class="col-md-6 col-sm-6 col-xs-12 content">
									<div class="title-box">
										<h4>Richard Leff</h4>
										<p>M.D., F.A.C.S.</p>
						...
						<div class="col-md-6 col-sm-6 col-xs-12 column">
							<article class="row clearfix">
								<figure class="col-md-6 col-sm-6 col-xs-12 image"><a href="#"><img src="http://www.sfvua.com/images/p-drmehdizadeh.jpg" alt=""></a></figure>
								<div class="col-md-6 col-sm-6 col-xs-12 content">
									<div class="title-box">
										<h4>Jennifer Mehdizadeh</h4>
										<p>M.D., F.A.C.S.</p>
									</div>
									<div class="text">
										<p>Etiam dignissim sit amet felis ac sagittis. Sed libero arcu, pharetra et ante in, elementum scelerisque arcu. Curabitur sagittis non justo at ultricies odio ac diam finibus. Etiam dignissim sit amet felis ac sagittis. Sed libero arcu, pharetra et ante in, elementum scelerisque arcu. Curabitur sagittis non justo at ultricies odio ac diam finibus.</p>
						...
						<div class="col-md-6 col-sm-6 col-xs-12 column">
							<article class="row clearfix">
								<figure class="col-md-6 col-sm-6 col-xs-12 image"><a href="#"><img src="http://www.sfvua.com/images/p-shapiro.jpg" alt=""></a></figure>
								<div class="col-md-6 col-sm-6 col-xs-12 content">
									<div class="title-box">
										<h4>Richard Shapiro</h4>
										<p>M.D., F.A.C.S.</p>
									</div>
									<div class="text">
										<p>Etiam dignissim sit amet felis ac sagittis. Sed libero arcu, pharetra et ante in, elementum scelerisque arcu. Curabitur sagittis non justo at ultricies odio ac diam finibus. Etiam dignissim sit amet felis ac sagittis. Sed libero arcu, pharetra et ante in, elementum scelerisque arcu. Curabitur sagittis non justo at ultricies odio ac diam finibus.</p>
				...
				<div class="container p-0">
					<div class="row clearfix">
						...
						<div class="col-md-6 col-sm-12 col-xs-12 wow slideInLeft p-0" data-wow-delay="0ms" data-wow-duration="1500ms">
							<img class="img-responsive" src="images/appointment.png" alt="">
						</div>
			...
			<!--Parallax Section-->
			<section class="parallax-section" style="background-image:url(images/bg-cta.jpg);">
				<div class="auto-container">
