...
<html>
	<head>
		<meta charset="utf-8">
		<title>Dr. Richard Shapiro | SFVUA</title>
	...
	<body>
		...
		<!--Page Title-->
		<section class="page-title" style="background-image:url(images/background/doctor.jpg);">
					...
					<div class="row">
						<div class="col-sx-12 col-sm-4 col-md-4 mb-30">
							<div class="doctor-thumb">
								<img class="img-responsive" src="/images/shapiro.jpg" alt="">
							</div>
